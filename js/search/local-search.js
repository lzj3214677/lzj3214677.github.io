window.addEventListener('load', () => {
  ...
  const search = () => {
    ...
    $input.addEventListener('input', function () {
      ...
      dataObj.then(data => {
        data.forEach(data => {
          let dataTags = data.tags ? data.tags.trim().toLowerCase() : ''  //��ȡ��ǩ
          let indexTag = -1	//- +++���ӱ�ǩ��λ����
          let l_keywords = keywords.toString().split('').length //- +++��ȡ�����ؼ��ʵĳ���
          let isMatch = true
          ...
          if (dataTitle !== '' || dataContent !== '') {
            keywords.forEach((keyword, i) => {
              if (keywords[0][0] === '#' && l_keywords > 1 && keywords[0][1] !== '#'){ //- ���һ���ж������޸���������'##'�޷�����������
                  //����ؼ��ʵ�һ���ַ���#�ҳ��ȴ���1����ô����tag����
                  keyword = keyword.substring(1) // ���ؼ��ʵ�һ��#ȥ������ƥ��
                  //- ����dataTags0�����壺ȥ��tags�������ҳ��ǩ���룬��������ҳ��ǩ����Ĵ��루���������ݣ�Ҳƥ��
                  let dataTags0 = ''
          ...
          if (isMatch) {
            if (firstOccur >= 0) {
              ...
              if (dataContent !== '') {
                //- �Զ��忪ʼ�����ɵ�����������������ʾtags
                let splitT = '' 
                //- ��һ����������ȥ��dataTags��Ǻ��ֺ���ĸ�����֣��Ĳ��֣�Ȼ�����������ַֺ�'����'�Ѹ���tags�ָ�����������spliT�����
                let space = 1
                for (let i=0;i<dataTags.length;i++){
                ...
                //- �ڶ����� highlight all keywords
                keywords.forEach(keyword => {
                  if(keyword[0] === '#' & keyword.length>1){
                    keyword = keyword.substring(1) // �����һ���ַ�Ϊ#�ҳ��ȴ���1�����ؼ��ʵ�һ��#ȥ������ƥ��
                  }     
                  splitT = splitT.replace(new RegExp(keyword,"gi"),'<span class="search-keyword">' + keyword + '</span>')
                }) 
                
                //- �����������ڵ�һ��������Ϊ���ı��Ұ���˫�ֺţ��˲���ȥ���ֺ��Ҽ���fas fa-tag���������壨������splitTags�
